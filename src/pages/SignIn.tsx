      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 rounded-xl border border-slate-200">
          <div className="text-center mb-8">
            <h1 className="mb-2 text-[#222222]">Welcome back</h1>
            <p className="text-[#555555]">Sign in to your Abun account</p>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <Button variant="outline" className="h-12 rounded-[10px] border-2">
